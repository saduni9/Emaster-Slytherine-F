...
const UploadVideos = ({ setAddLessonForm }) => {
  ...
  const handleUploadAll = async () => {
    ...
    const uploadedUrls = [];
    const newProgressBars = Array.from({ length: videos.length }, () => 0);
    ...
    setProgressBars(newProgressBars.map(() => 100));
            ...
            <Field
              ...
              className={`${
                errors.course && touched.course
                  ? 'is-invalid add-course-form-input'
